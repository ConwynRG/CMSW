...
<div class="container">
        ...
        <div class="col-md-8 mx-auto">
            ...
            {{Form::open(array('action'=>['SettingsController@updateSettings',Auth::id()], 'enctype'=>'multipart/form-data','method'=>'PUT'))}}
                ...
                <div class="mb-3">
                    {{Form::label('aboutMe', __('messages.about'))}} <span class="text-muted">({{__('messages.optional')}})</span>
                    {{Form::textarea('aboutMe', $user->about_me, ['class' => 'form-control'.($errors->has('aboutMe') ? ' is-invalid' : ''), 'placeholder'=>__('messages.desc_placeholder'), 'rows'=>'6']) }}                    
                ...
                <hr class="mb-4">
                <h4 class="mb-3">{{__('messages.profile_img_settings')}}</h4>
                <div class="row" id="avatar-image-section">
                    ...
                    <div class="col-md-6 mx-auto my-md-5">
                        {{Form::label('avatarImgFile', __('messages.avatar_file')) }}
