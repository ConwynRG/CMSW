...
class PostSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Post::create(array('user_id'=>1, 'page_id'=>1,'mainImage_id'=>1,'title'=>'Test titke for recipe',
        ...
        Post::create(array('user_id'=>2, 'page_id'=>2,'mainImage_id'=>1,'title'=>'Recipe title',
            'short_description'=>'Very short', 'description'=>null, 'rating'=>0,
            'isRecipe'=>true,'isPublic'=>true));
        Post::create(array('user_id'=>3, 'page_id'=>3,'mainImage_id'=>1,'title'=>'Long title in case difficult dish or post',
            'short_description'=>'Short description just to adjust sizes and other stuff','description'=>null,'rating'=>0,
            'isRecipe'=>false,'isPublic'=>true));
    }
}
